...
img_news_title=driver.find_element_by_xpath("//div[@class='img-news-display']/descendant::p[@class='img-news-title']")
print("文章标题为%s"%img_news_title.text)
img_news.click()
driver.refresh()
time.sleep(1)
...
#判断是否已经可以打卡
# if is_element_exists("//a[@class='checkin-btn']"):
